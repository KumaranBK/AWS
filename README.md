...
What is AWS and why IT is used?
...
My Personal Opinion about AWS:

AWS is an popular cloud computing platform. whic works as SAAS (Software as a Service) through which you can integrate all the required, sofware, applications, API, etc. 


Good Luck..! Lets Proceed further.
